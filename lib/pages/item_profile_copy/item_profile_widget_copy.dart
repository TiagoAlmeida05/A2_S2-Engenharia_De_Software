...
class ItemProfileWidgetCopy extends StatefulWidget {
  const ItemProfileWidgetCopy({
    super.key,
    required this.name,
    required this.price,
    required this.brand,
  ...
  static String routeName = 'ItemProfileCopy';
  static String routePath = '/itemProfileCopy';

  @override
  State<ItemProfileWidgetCopy> createState() => _ItemProfileWidgetCopyState();
}

class _ItemProfileWidgetCopyState extends State<ItemProfileWidgetCopy> {
  @override
