...
class FoodRecord extends FirestoreRecord {
  ...
  // "FavouritesFood" field.
  List<DocumentReference>? _favouritesFood;
  List<DocumentReference> get favouritesFood => _favouritesFood ?? const [];
  bool hasFavouritesFood() => _favouritesFood != null;
  ...
  void _initializeFields() {
    ...
    _favouritesFood = getDataList(snapshotData['FavouritesFood']);
  }
...
class FoodRecordDocumentEquality implements Equality<FoodRecord> {
  ...
  bool equals(FoodRecord? e1, FoodRecord? e2) {
    ...
    return e1?.name == e2?.name &&
        ...
        listEquality.equals(e1?.favouritesFood, e2?.favouritesFood);
  }
