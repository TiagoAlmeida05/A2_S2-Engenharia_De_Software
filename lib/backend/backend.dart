...
import 'schema/all_clothes_record.dart';
...
export 'schema/all_clothes_record.dart';
...
/// Functions to query AllClothesRecords (as a Stream and as a Future).
Future<int> queryAllClothesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      AllClothesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<AllClothesRecord>> queryAllClothesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      AllClothesRecord.collection,
      AllClothesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<AllClothesRecord>> queryAllClothesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
