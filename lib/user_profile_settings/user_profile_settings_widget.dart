  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> userProfileSettingsUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final userProfileSettingsUsersRecord =
            userProfileSettingsUsersRecordList.isNotEmpty
                ? userProfileSettingsUsersRecordList.first
                : null;
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              FFAppState().VisibilidadeNewPassword = true;
                              safeSetState(() {});
                            },
                          ...
                          Container(
                            ...
                            child: Visibility(
                              visible: FFAppState().VisibilidadeNewPassword,
                              child: Column(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                  Expanded(
